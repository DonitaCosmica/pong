...
namespace pong {
  GameMode2v1::GameMode2v1(std::unique_ptr<Board> board, std::shared_ptr<Player> player1,
    std::shared_ptr<Player> player2, std::shared_ptr<Player> player3, std::unique_ptr<Ball> ball)
